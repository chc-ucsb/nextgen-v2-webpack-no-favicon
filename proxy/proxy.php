...
/**
 * The code for this proxy is taken from https://github.com/softius/php-cross-domain-proxy
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * How to enable CORS for PHP proxy (EROS):
 * Log into vs200
 * Open IIS Manager
 * Select your site from the list
 * Open the HTTP Response Headers feature
 * Click Add...
 * Set the name to: Access-Control-Allow-Origin
 * Set the value to: *
 * Click OK
 * Copy the proxy file to your dev area
 */
