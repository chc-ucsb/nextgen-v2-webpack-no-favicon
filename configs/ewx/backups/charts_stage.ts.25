export const charts = [
   ...
   // Imerg late Africa
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['imerglate_global_pentad_mean'],
    },
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['imerglate_global_1_monthly_mean'],
    },
  ...
  // CHIRP v3.1 Beta Africa
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p1_global_pentad_mean'],
    },
    overlays: ['chirpv3p1AfricaDataPentadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_pentad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p1_global_dekad_mean'],
    },
    overlays: ['chirpv3p1AfricaDataDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_dekad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaAnomalyDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_dekad_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaZscoreDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_dekad_zscore.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p1_global_1_monthly_mean'],
    },
    overlays: ['chirpv3p1AfricaData1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_1_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaAnomaly1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_1_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaZscore1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_1_monthly_zscore.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p1_global_2_monthly_mean'],
    },
    overlays: ['chirpv3p1AfricaData2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_2_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaAnomaly2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_2_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaZscore2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_2_monthly_zscore.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p1_global_3_monthly_mean'],
    },
    overlays: ['chirpv3p1AfricaData3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_3_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaAnomaly3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_3_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p1AfricaZscore3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p1_global_3_monthly_zscore.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  // CHIRP v3.2 Beta Africa
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p2_global_pentad_mean'],
    },
    overlays: ['chirpv3p2AfricaDataPentadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_pentad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p2AfricaAnomalyPentadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_pentad_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p2_global_dekad_mean'],
    },
    overlays: ['chirpv3p2AfricaDataDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_dekad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p2AfricaAnomalyDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_dekad_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p2_global_1_monthly_mean'],
    },
    overlays: ['chirpv3p2AfricaData1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_1_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p2AfricaAnomaly1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_1_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p2_global_2_monthly_mean'],
    },
    overlays: ['chirpv3p2AfricaData2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_2_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p2AfricaAnomaly2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_2_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpv3p2_global_3_monthly_mean'],
    },
    overlays: ['chirpv3p2AfricaData3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_3_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpv3p2AfricaAnomaly3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpv3p2_global_3_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  // CHIRPS v3.2 Beta Africa
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p2_global_pentad_mean'],
    },
    overlays: ['chirpsv3p2AfricaDataPentadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_pentad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2AfricaAnomPentadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_pentad_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p2_global_dekad_mean'],
    },
    overlays: ['chirpsv3p2AfricaDataDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_dekad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2AfricaAnomDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_dekad_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p2_global_1_monthly_mean'],
    },
    overlays: ['chirpsv3p2AfricaData1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_1_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2AfricaAnomaly1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_1_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p2_global_2_monthly_mean'],
    },
    overlays: ['chirpsv3p2AfricaData2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_2_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2AfricaAnomaly2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_2_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p2_global_3_monthly_mean'],
    },
    overlays: ['chirpsv3p2AfricaData3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_3_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2AfricaAnomaly3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p2_global_3_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  // CHIRPS v3.3 Beta Africa
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p3_global_pentad_mean'],
    },
    overlays: ['chirpsv3p3AfricaDataPentadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_pentad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3AfricaAnomPentadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_pentad_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p3_global_dekad_mean'],
    },
    overlays: ['chirpsv3p3AfricaDataDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_dekad_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3AfricaAnomDekadal'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_dekad_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p3_global_1_monthly_mean'],
    },
    overlays: ['chirpsv3p3AfricaData1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_1_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3AfricaAnomaly1Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_1_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p3_global_2_monthly_mean'],
    },
    overlays: ['chirpsv3p3AfricaData2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_2_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3AfricaAnomaly2Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_2_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirpsv3p3_global_3_monthly_mean'],
    },
    overlays: ['chirpsv3p3AfricaData3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_3_monthly_data.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3AfricaAnomaly3Monthly'],
    boundaries: ['africaAdmin1','africaAdmin2','africaCropzones','kenyaWards'],
    boundaryLabels: ['Admin1','Admin2','Crop Zones','Kenya Wards'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
        dataRoot: 'chirpsv3p3_global_3_monthly_anom.data',
        yAxisRange: 'auto',
      },
      {
        graphTypes: ['bar', 'line'],
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirts-era5tmin_global_1_montly_mean'],
    },
  ...
  },
  {
   ...
   // CHIRPv 3.1 Beta Central America
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
    ...
    overlays: ['chirpv3p1CamcarDataPentadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarDataDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarAnomalyDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarZscoreDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarData1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarAnomaly1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarZscore1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarData2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarAnomaly2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarZscore2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarData3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarAnomaly3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1CamcarZscore3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
   ...
   // CHIRPv 3.2 Beta Central America
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
    ...
    overlays: ['chirpv3p2CamcarDataPentadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarAnomalyPentadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarDataDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarAnomalyDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarData1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarAnomaly1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarData2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarAnomaly2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarData3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2CamcarAnomaly3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  // CHIRPS v 3.2 Beta Central America
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
    ...
    overlays: ['chirpsv3p2CamcarDataPentadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarDataDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarAnomalyDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarData1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarAnomaly1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarData2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarAnomaly2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarData3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2CamcarAnomaly3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  // CHIRPS v 3.3 Beta Central America
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
    ...
    overlays: ['chirpsv3p3CamcarDataPentadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarDataDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarAnomalyDekadal'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarData1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarAnomaly1Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarData2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarAnomaly2Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarData3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3CamcarAnomaly3Monthly'],
    boundaries: ['camcarAdmin0','camcarAdmin1','camcarAdmin2'],
    boundaryLabels: ['Countries','Admin 1','Admin 2'],
    chartTypes: [
      {
  ...
  // CHIRPS Global
  {
    ...
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1','gbLakeVictoriaAdmin0'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1','Lake Victoria Basin'],
    chartTypes: [
      {
        graphTypes: ['bar', 'line'],
        dataType: 'annual',
  ...
  // CHIRPv3.1 Beta Global
  {
    ...
    overlays: ['chirpv3p1GlobalDataPentadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalDataDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalAnomalyDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalZscoreDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalData1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalAnomaly1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalZscore1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalData2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalAnomaly2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalZscore2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalData3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalAnomaly3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p1GlobalZscore3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  // CHIRPv3.2 Beta Global
  {
    ...
    overlays: ['chirpv3p2GlobalDataPentadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalAnomalyPentadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalDataDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalAnomalyDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalData1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalAnomaly1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalData2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalAnomaly2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalData3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpv3p2GlobalAnomaly3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  // CHIRPS v3.2 Beta Global
  {
    ...
    overlays: ['chirpsv3p2GlobalDataPentadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalDataDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalAnomalyDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalData1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalAnomaly1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalData2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalAnomaly2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalData3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p2GlobalAnomaly3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  // CHIRPS v3.3 Beta Global
  {
    ...
    overlays: ['chirpsv3p3GlobalDataPentadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalDataDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalAnomalyDekadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalData1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalAnomaly1Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalData2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalAnomaly2Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalData3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    ...
    overlays: ['chirpsv3p3GlobalAnomaly3Monthly'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  // CHIRTS-ERA5 Tmin Global
  {
    ...
    overlays: ['chirtsra5minGlobalDataPentadal'],
    boundaries: ['gbafricaAdmin1','gbafricaAdmin2','gbafricaCropzones','gbcamcarAdmin0','gbcamcarAdmin1','gbcamcarAdmin2','afghanAdmin1','afghanAdmin2','colombiaAdmin1','colombiaAdmin2','usAdmin1','usAdmin2','venezuelaAdmin1','venezuelaAdmin2','yemenAdmin1'],
    boundaryLabels: ['Africa Admin 1','Africa Admin 2','African Crop Zones', 'Central America and Caribbean Countries','Central America and Caribbean Admin 1','Central America and Caribbean Admin 2','Afghanistan Admin 1','Afghanistan Admin 2','Colombia Admin 1','Colombia Admin 2','United States of America Admin 1','United States of America Admin 2','Venezuela Admin 1','Venezuela Admin 2','Yemen Admin 1'],
    chartTypes: [
      {
  ...
  },
  {
    source: {
      url:
        'https://chc-ewx3.chc.ucsb.edu/api/rest/timeseries/version/5.0/vector_dataset/{{vector_dataset}}/raster_dataset/{{raster_dataset}}/periodicity/{{periodicity}}/statistic/{{statistic}}/lat/{{lat}}/lon/{{lon}}/seasons/{{seasons}}/zonal_stat_type/mean/mean-median/true',
      type: 'json',
      staticSeasonNames: ['chirts-era5tmin_global_1_monthly'],
    },
