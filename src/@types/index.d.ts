...
export type PeriodType = 'day' | 'week' | 'firedanger_week' | '14day' | 'pentad' | 'dekad' | 'month' | '2month' | '3month' | '4month' | '5month' | '6month';
...
export type AbbrShort4Month = ['JFMA', 'FMAM', 'MAMJ', 'AMJJ', 'MJJA', 'JJAS', 'JASO', 'ASON', 'SOND', 'ONDJ', 'NDJF', 'DJFM'];
export type AbbrShort5Month = ['JFMAM', 'FMAMJ', 'MAMJJ', 'AMJJA', 'MJJAS', 'JJASO', 'JASON', 'ASOND', 'SONDJ', 'ONDJF', 'NDJFM', 'DJFMA'];
export type AbbrShort6Month = ['JFMAMJ', 'FMAMJJ', 'MAMJJA', 'AMJJAS', 'MJJASO', 'JJASON', 'JASOND', 'ASONDJ', 'SONDJF', 'ONDJFM', 'NDJFMA', 'DJFMAM'];
...
export interface PeriodConfig {
  ...
  shortName?: string;
  fullName: string;
  months: Abbr1Month | Abbr2Month | Abbr3Month | Abbr4Month | Abbr5Month | Abbr6Month;
  shortMonths: AbbrShort1Month | AbbrShort2Month | AbbrShort3Month | AbbrShort4Month | AbbrShort5Month | AbbrShort6Month;
  style: string;
  type: PeriodType;
